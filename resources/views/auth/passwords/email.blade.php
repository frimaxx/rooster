...
@section('content')
    ...
    <div class="center-block w-xxl w-auto-xs p-y-md">
        ...
        <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
            ...
            <form method="post" action="{{ route('password.email') }}" name="form">
                {{csrf_field()}}
                ...
                <button style="background: #5f9dc4; color: white;" type="submit" class="btn btn-block p-x-md">Resetten</button>
            </form>
        </div>
