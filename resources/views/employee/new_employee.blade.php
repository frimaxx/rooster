...
@section('title') Nieuwe medewerker maken @endsection
...
@section('content')
    ...
    <div class="padding">
        <div class="col-md-6">
            <h1 style="margin-bottom: 40px">Nieuwe medewerker toevoegen</h1>
            <form action="" method="post">
                    ...
                    <div class="form-group {{ $errors->has('filiaal') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-md-9">
                            <select name="filiaal" class="form-control">
                                @if(empty(old('filiaal')) && Auth::user()->level() > 2)
                ...
                <div style="margin-top: 10px;" class="row">
                    <div class="col-md-11">
                        <input value="Medewerker toevoegen" type="submit" class="btn btn-primary pull-right">
                    </div>
                </div>
