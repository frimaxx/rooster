...
<div class="app" id="app">
    ...
    <div class="app-body amber bg-auto w-full">
        <div class="text-center pos-rlt p-y-md">
            ...
            <h2 class="h1 m-y-lg text-black">OEPS!</h2>
            <p class="h5 m-y-lg text-u-c font-bold text-black">Sorry! Die pagina konden we net vinden</p>
            <a href="/" class="md-btn amber-700 md-raised p-x-md">
                <span class="text-white">Terug naar bekend gebied</span>
            </a>
        </div>
    </div>
