  ...
  <div class="box">
    ...
    <table st-table="rowCollectionBasic" class="table table-bordered table-striped">
      ...
      <tr ng-repeat="row in rowCollectionBasic">
        ...
        <td>
          <button class="btn btn-sm" data-placement="top" data-content="{{row.email}}" bs-popover type="button">
            <i class="fa fa-eye"></i>
          </button>
          <a ng-href="mailto:{{row.email}}">email</a></td>
        <td>
          <button type="button" ng-click="removeRow(row)" class="btn btn-sm white">
            <i class="fa fa-times">
            </i>
          </button>
        </td>
      ...
      <tfoot>
        <tr>
          <td colspan="5" class="text-center">
            <div st-pagination="" st-items-by-page="itemsByPage" st-displayed-pages="7" class="m-a-0"></div>
          </td>
        </tr>
      </tfoot>
    </table>
